          ...
          <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
               <div class="container">
                    ...
                    <div class="navbar-header">
                         ...
                         <a href="user.php" class="navbar-brand"><img height="50px" width="150px" src="../images/octatix-logo.png" alt="LogoTubes"></a>
                    </div>
                    ...
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr class="total">
                            <td></td>
                              ...
                              <td>Terimakasih telah mempercayai OCTATIX Sebagai <br>

...
<head>
     ...
     <title>OCTATIX - Update Data Konser</title>
     ...
     <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <a href="index.php" class="navbar-brand"><img height="50px" width="150px" src="../images/octatix-logo.png" alt="LogoTubes"></a>
               </div>
                    ...
                    <div class="col-md-12 col-sm-12">
                         <div class="footer-bottom">
                                   <div class="copyright-text"> 
                                        <center><p>Copyright &copy; 2023 OCTATIX</p></center>
                                   </div>
                         </div>
                    </div>
